...
test("every hand-over the og skill prints is one this script accepts", { skip: !existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md")) && "Grok authoring skill is not part of this application repository" }, () => {
